 ...
 */
function PencilObj(x, y, v, xp, yp, col, l) {
    this.type = 'pencil';
    this.x = x;
    this.y = y;
    this.v = v;
 ...
 * @param {int} l layer on wich it will be drawen 0 is the background and 1 the foreground
 */
function LineObj(x, y, v, xp, yp, col, l) {
    this.type = 'line';
    this.x = x;
    this.y = y;
    this.v = v;
 ...
 * @param {int} l layer on wich it will be drawen 0 is the background and 1 the foreground
 */
function RectObj(x, y, v, width, height, col, filled, l) {
    this.type = 'rect';
    this.x = x;
    this.y = y;
    this.v = v;
 ...
 * @param {int} l layer on wich it will be drawen 0 is the background and 1 the foreground
 */
function CircleObj(x, y, v, width, height, col, filled, l) {
    this.type = 'circle';
    this.x = x;
    this.y = y;
    this.v = v;
 ...
 * @param {int} l layer on wich it will be drawen 0 is the background and 1 the foreground
 */
function TextObj(x, y, str, size, family, col, l) {
    this.type = 'text';
    this.x = x;
    this.y = y;
    this.str = str;
